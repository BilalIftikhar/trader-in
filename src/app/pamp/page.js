          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="md:w-1/2 relative">
              ...
              <div className="absolute -top-10 -left-10 bg-black p-6 rounded-xl shadow-xl hidden md:block">
                <p className="text-4xl font-bold text-white">Local Trust</p>
                <p className="text-gray-300">Made in Pakistan</p>
              </div>
            </div>
            ...
            <div className="md:w-1/2 mt-16 md:mt-0">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                PAM-P – uPVC Windows & Doors Built for Pakistani Conditions
              </h2>
